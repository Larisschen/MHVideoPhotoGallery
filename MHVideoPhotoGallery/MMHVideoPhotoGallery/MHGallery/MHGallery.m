...
NSString * const MHYoutubeAPIKey           = @"AIzaSyAAEMhvvukcqhBc7_s5otUhwrMFJ5s7d40";
...
NSString * const MHYoutubeInfoBaseURL      = @"https://www.googleapis.com/youtube/v3/videos?part=snippet,contentDetails,statistics,status&id=%@&key=%@";
